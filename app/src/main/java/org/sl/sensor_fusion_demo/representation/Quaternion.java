package org.sl.sensor_fusion_demo.representation;
...
public class Quaternion extends Vector4f {
   ...
   * @param t The ratio between the two quaternions where 0 <= t <= 1.0 . Increase value of t will bring rotation closer to the input quaternion.
   */
